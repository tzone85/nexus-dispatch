...
// rejectionDetail is what the OPERATOR log gets for a rejected path: the
// real target and the underlying error, where the agent-facing message
// (errReason) carries neither. A blocked escape attempt is worth noticing.
