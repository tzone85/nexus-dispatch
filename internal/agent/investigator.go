...
// or implementation begins, following seven ordered investigation phases.
...
Follow these 7 investigation phases IN ORDER:
...
After all 7 phases, call submit_report with a structured JSON report.`
}
...
func InvestigatorTools() []llm.ToolDefinition {
	return []llm.ToolDefinition{
		...
		{
			Name:        "submit_report",
			Description: "Submit the final investigation report. Call this ONCE after completing all 7 phases.",
			Parameters:  json.RawMessage(`{"type":"object","properties":{"summary":{"type":"string","description":"200-word architecture brief"},"entry_points":{"type":"array","items":{"type":"string"}},"modules":{"type":"array","items":{"type":"object","properties":{"name":{"type":"string"},"path":{"type":"string"},"file_count":{"type":"integer"},"line_count":{"type":"integer"},"has_tests":{"type":"boolean"}},"required":["name","path"]}},"build_passes":{"type":"boolean"},"test_passes":{"type":"boolean"},"test_count":{"type":"integer"},"coverage_pct":{"type":"number"},"code_smells":{"type":"array","items":{"type":"object","properties":{"file":{"type":"string"},"severity":{"type":"string"},"description":{"type":"string"}},"required":["file","severity","description"]}},"risk_areas":{"type":"array","items":{"type":"object","properties":{"file":{"type":"string"},"reason":{"type":"string"},"severity":{"type":"string"}},"required":["file","reason","severity"]}},"conventions":{"type":"array","items":{"type":"object","properties":{"area":{"type":"string"},"pattern":{"type":"string"},"example_file":{"type":"string"}},"required":["area","pattern"]}},"recommendations":{"type":"array","items":{"type":"string"}}},"required":["summary","entry_points","build_passes","test_passes","recommendations"]}`),
		},
	}
}
